/**
 * v0 by Vercel.
 * @see https://v0.dev/t/RWFtOBcXYfT
 */
    ...
    <footer className="w-full p-4 bg-gray-800 text-white">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div className="flex space-x-4">
          ...
          <Link href="#">
            <IconLinkedIn className="h-6 w-6 text-white" />
            <span className="sr-only">LinkedIn</span>
          </Link>
        </div>
        <div className="flex mt-4 md:mt-0">
          <p className="mr-2">© The Gateway People. All rights reserved.</p>
          <Link className="text-blue-400 hover:underline" href="/about">
            About Us
          </Link>
        </div>
      </div>
